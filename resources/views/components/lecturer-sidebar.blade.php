    ...
    <nav class="flex-1 p-3 space-y-2 mt-5">
        ...
        <a href="{{ route('lecturer.teaching.index') }}"
           class="{{ $linkBase }} {{ $isActive('lecturer.teaching.index') ? $active : $inactive }}">
            ...
            <span class="menu-text text-md {{ $isActive('teaching.*') ? 'font-semibold' : 'font-medium' }}">
                Teaching
            </span>
        </a>
        ...
        <a href="{{ route('lecturer.research.index') }}"
           class="{{ $linkBase }} {{ $isActive('lecturer.research.index') ? $active : $inactive }}">
            ...
            <span class="menu-text text-md {{ $isActive('research.*') ? 'font-semibold' : 'font-medium' }}">
                Research
            </span>
        </a>
