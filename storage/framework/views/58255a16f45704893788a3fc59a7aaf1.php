            ...
            <div class="card bg-base-200">
                <div class="card-body">
                    ...
                    <div class="mt-4 space-y-2">
                        <a href="<?php echo e(route('lecturer.teaching.index')); ?>" class="btn btn-outline w-full">
                            Lengkapi Aktivitas
                        </a>
                        <a href="<?php echo e(route('lecturer.submissions.index')); ?>" class="btn btn-ghost w-full">
                            Riwayat Pengajuan
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard-lecturer-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\traec\resources\views/pages/lecturer/period/status.blade.php ENDPATH**/ ?>