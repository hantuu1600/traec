...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('lecturer.research.create')); ?>" class="btn btn-primary btn-sm">
                + Add Research
            </a>
        </div>
...
<?php endif; ?>
                <?php else: ?>
                    <div class="rounded-box border border-base-300 bg-base-100 p-6">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <a href="<?php echo e(route('lecturer.research.create')); ?>" class="btn btn-primary">
                                + Add Research
                            </a>
                        </div>
                    </div>
        ...
        <?php $__currentLoopData = $researchs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $research): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <input type="checkbox" id="research-member-modal-<?php echo e($research->id); ?>" class="modal-toggle" />
            ...
            <div class="modal">
                <div class="modal-box max-w-lg">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $members[$research->id] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-base-content/70"><?php echo e($member->role); ?></td>
                                    </tr>
                    ...
                    <div class="modal-action">
                        <label for="research-member-modal-<?php echo e($research->id); ?>" class="btn btn-sm">
                            Close
                        </label>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard-lecturer-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\traec\resources\views/pages/lecturer/research/index.blade.php ENDPATH**/ ?>