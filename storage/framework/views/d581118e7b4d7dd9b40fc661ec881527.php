...
<?php endif; ?>
  ...
  <?php if (isset($component)) { $__componentOriginal30fa79e2003f78a19facdefba7d70115 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal30fa79e2003f78a19facdefba7d70115 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.activity-table-admin','data' => ['rows' => $rows]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('activity-table-admin'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal30fa79e2003f78a19facdefba7d70115)): ?>
<?php $attributes = $__attributesOriginal30fa79e2003f78a19facdefba7d70115; ?>
<?php unset($__attributesOriginal30fa79e2003f78a19facdefba7d70115); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal30fa79e2003f78a19facdefba7d70115)): ?>
<?php $component = $__componentOriginal30fa79e2003f78a19facdefba7d70115; ?>
<?php unset($__componentOriginal30fa79e2003f78a19facdefba7d70115); ?>
<?php endif; ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard-admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\traec\resources\views/pages/admin/dashboard.blade.php ENDPATH**/ ?>