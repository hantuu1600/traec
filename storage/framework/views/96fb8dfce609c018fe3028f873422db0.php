<aside id="sidebar" class="sticky top-16 h-[calc(100vh-4rem)] w-64 bg-base-100 border-r border-base-300 flex flex-col transition-all duration-300">
    ...
    <nav class="flex-1 p-3 space-y-2 mt-5 overflow-auto">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>"
            class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.dashboard') ? $active : $inactive); ?>">

            <span class="<?php echo e($iconBox); ?>">
            ...
            <span class="menu-text text-md <?php echo e($isActive('admin.dashboard') ? 'font-semibold' : 'font-medium'); ?>">
                Home
            </span>
        </a>

        
        <a href="<?php echo e(route('admin.lecturers.index')); ?>"
            class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.lecturers.index') ? $active : $inactive); ?>">

            <span class="<?php echo e($iconBox); ?>">
                <svg class="<?php echo e($iconSvg); ?>" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="menu-text text-md <?php echo e($isActive('admin.lecturers') ? 'font-semibold' : 'font-medium'); ?>">
                Lecturers
            </span>
        </a>

        
        <a href="<?php echo e(route('admin.document-request.index')); ?>"
            class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.document-request*') ? $active : $inactive); ?>">
            ...
            <span class="menu-text text-md <?php echo e($isActive('admin.document-request') ? 'font-semibold' : 'font-medium'); ?>">
                Documents
            </span>
        </a>
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>"
            class="<?php echo e($linkBase); ?> <?php echo e($isActive('settings.*') ? $active : $inactive); ?>">
            ...
            <span class="menu-text text-md <?php echo e($isActive('settings.*') ? 'font-semibold' : 'font-medium'); ?>">
                Settings
            </span>
        </a>

        <a href="<?php echo e(route('admin.periods.index')); ?>"
            class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.periods.*') ? $active : $inactive); ?>"
            aria-current="<?php echo e($isActive('admin.periods.*') ? 'page' : 'false'); ?>">
            <span
                class="<?php echo e($iconBox); ?> <?php echo e($isActive('admin.periods.*') ? 'bg-primary/20' : 'bg-base-200/60 group-hover:bg-base-200'); ?>">
            ...
            <span class="menu-text text-md <?php echo e($isActive('admin.periods.*') ? 'font-semibold' : 'font-medium'); ?>">
                Manage Period
            </span>
        </a>
        <?php if(auth()->user()->role === 'super_admin'): ?>
            
            <a href="<?php echo e(route('superadmin.admins.index')); ?>"
                class="<?php echo e($linkBase); ?> <?php echo e($isActive('superadmin.admins.*') ? $active : $inactive); ?>">
                <span class="<?php echo e($iconBox); ?>">
                    <svg class="<?php echo e($iconSvg); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <span class="menu-text text-md <?php echo e($isActive('superadmin.admins.*') ? 'font-semibold' : 'font-medium'); ?>">
                    Manage Admin
                </span>
            </a>
        <?php endif; ?>
...
</aside><?php /**PATH D:\traec\resources\views/components/admin-sidebar.blade.php ENDPATH**/ ?>